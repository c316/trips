    ...
    function generateMask(mask, metadata) {
      ...
      if (opts.repeat > 0 || opts.repeat === '*' || opts.repeat === '+') {
        ...
        mask = `${opts.groupmarker.start +
          ...
          repeatStart},${opts.repeat}${opts.quantifiermarker.end}`;
      }
  ...
  function maskScope(actionObj, maskset, opts) {
    ...
    function getMaskTemplate(baseOnInput, minimalPos, includeInput) {
      ...
      do {
        if (baseOnInput === true && getMaskSet().validPositions[pos]) {
          ...
          maskTemplate.push(
            includeInput === true ? validPos.input : getPlaceholder(pos, test),
          );
        } else {
    ...
    function getTests(pos, ndxIntlzr, tstPs) {
      ...
      if (pos > -1) {
        ...
        for (
          ...
          const match = resolveTestFromToken(
            maskTokens[mtndx],
            ndxInitializer,
            [mtndx],
          );
      ...
      function alternate(pos, c, strict) {
        ...
        if (alternation !== undefined) {
          ...
          let decisionTaker =
            ...
            undefined
              ? prevAltPos.locator[prevAltPos.alternation || alternation]
              : altNdxs[0]; // no match in the alternations (length mismatch)
            ...
            function(ndx, test) {
              ...
              for (let mndx = 0; mndx < altNdxs.length; mndx++) {
                ...
                if (
                  ...
                  const possibilities = getMaskSet().validPositions[decisionPos]
                    .locator;
                  getMaskSet().validPositions[decisionPos].locator[
                    alternation
                  ] = parseInt(altNdxs[mndx]); // set forced decision
                  if (test.match.fn == null) {
                    ...
                    getMaskSet().validPositions[
                      decisionPos
                    ].generatedInput = !/[0-9a-bA-Z]/.test(test.match.def);
                  ...
                  if (isValidRslt) {
                    getMaskSet().validPositions[
                      decisionPos
                    ].locator = possibilities; // reset forceddecision ~ needed for proper delete
      ...
      for (pndx++; pndx < maskPos; pndx++) {
        if (
          ...
          ((testTemplate = getTestTemplate(
            ...
            pndx - 1,
          )).match.def === opts.radixPointDefinitionSymbol ||
            !isMask(pndx, true) ||
      ...
      if (maskPos < getMaskSet().maskLength) {
        ...
        if ((!strict || fromSetValid === true) && result === false) {
          ...
          if (
            ...
            for (
              let nPos = maskPos + 1, snPos = seekNext(maskPos);
              nPos <= snPos;
              nPos++
            ) {
    ...
    function checkVal(input, writeOut, strict, nptvl, initiatingEvent) {
      ...
      function isTemplateMatch() {
        let isMatch = false;
        const charCodeNdx = getBufferTemplate()
          .slice(initialNdx, seekNext(initialNdx))
          .join('')
          .indexOf(charCodes);
        if (charCodeNdx !== -1 && !isMask(initialNdx)) {
          isMatch = true;
          const bufferTemplateArr = getBufferTemplate().slice(
            initialNdx,
      ...
      if (!strict) {
        if (opts.autoUnmask !== true) {
          let staticInput = getBufferTemplate()
              .slice(0, seekNext(-1))
              .join(''),
            matches = inputValue
              .join('')
      ...
      if (writeOut) {
        let caretPos =
            document.activeElement === input && (initiatingEvent || result)
              ? initiatingEvent
                ? caret(input).begin
                : result.forwardPosition
              : undefined,
    ...
    function patchValueProperty(npt) {
      ...
      function installNativeValueSetFallback(npt) {
        EventRuler.on(npt, 'mouseenter', function(event) {
          ...
          if (
            value !== getBuffer().join('') /* && getLastValidPosition() > 0 */
          ) {
      ...
      function generalize() {
        if (opts.keepStatic) {
          ...
          for (; lastAlt >= 0; lastAlt--) {
            ...
            if (altPos) {
              if (
                /* altPos.generatedInput !== true && */ /[0-9a-bA-Z]/.test(
                  altPos.input,
                )
              ) {
    ...
    function mask(elem) {
      ...
      if (
        ...
        const initialValue = $.isFunction(opts.onBeforeMask)
          ...
          if ($.isArray(maskset.metadata)) {
            ...
            for (var firstAlt = lvp; firstAlt >= 0; firstAlt--) {
              if (
                ...
                getMaskSet().validPositions[firstAlt].alternation !== undefined
              ) {
                alternation = getMaskSet().validPositions[firstAlt].alternation;
                break;
              }
            }
            return alternation !== undefined
              ? maskset.metadata[
